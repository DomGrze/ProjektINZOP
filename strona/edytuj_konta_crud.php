                ...
                <div id="mid-content">
                    <?php
                        ...
                        while($res=mysqli_fetch_array($query)){
                            ...
                            echo '<label for="imie">Imie:</label><br><input type=text name="imie" pattern="[a-zA-Z]"  maxlength="30" title="podaj imie" value="'.$res['imie'].'"required><br>';
                            
                            echo '<label for="nazwisko">Nazwisko:</label><br><input type=text pattern="[a-zA-Z]"  maxlength="30" name="nazwisko" title="podaj nazwisko" value="'.$res['nazwisko'].'"required><br>';
